...
class ToolCallingAgent:
    ...
    async def _execute_tool(self, tool_name: str, tool_input: Dict[str, Any]) -> str | list[Dict[str, Any]]:
        ...
        try:
            ...
            result_content = []
            try:
                result: CallToolResult = await self.mcp_client.call_tool(tool_name, tool_input, timeout=300, raise_on_error=False)
                ...
                result_content.append(f"Client Side Tool Execution Error: {str(e)}\n{traceback.format_exc()}")
                return result_content
            return result_content
        except Exception as e:
            traceback.print_exc()
