#!/usr/bin/env python3
"""
Aspirin Molecular Dynamics Simulation with xTB and PyMOL Visualization
"""
...
"""
    ...
    print(f"MD input file: {input_file}")
        ...
        for pymol_cmd in pymol_commands:
            try:
                ...
                if result.returncode == 0:
                    ...
                    print(f"PyMOL failed with return code: {result.returncode}")
                    print(f"stderr: {result.stderr}")
                    
            except (subprocess.TimeoutExpired, FileNotFoundError) as e:
                print(f"Failed with {pymol_cmd}: {e}")
                continue
